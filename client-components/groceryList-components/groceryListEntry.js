...
class GroceryListEntry extends React.Component {
  ...
  render() {
    return (
      <Swipeout
        left={[{text: 'To Pantry', backgroundColor: '#2089DC', disabled: this.state.toPantryButtonDisabled, onPress: () => {this.props.item.ispurchased = true; this.props.purchaseSpecificIngredient([this.props.item]); this.setState({toPantryButtonDisabled: true});}}]}
