      ...
      >
        ...
        <Animated.View style={{ ...this.props.style, opacity: fadeAnim }}>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => <HomeRecipes item={item} index={index} email={this.props.screenProps.email} getUserRecipes={this.props.screenProps.getUserRecipes} ingredients={this.props.screenProps.ingredients} getUserGroceries={this.props.screenProps.getUserGroceries} />}
